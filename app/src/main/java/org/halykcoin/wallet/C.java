...
public abstract class C {
    ...
    public static final String ETHEREUM_NETWORK_NAME = "Halykcoin";
    ...
    public static final String ETHEREUM_TIKER = "halykcoin";
    public static final String POA_TIKER = "poa";

    public static final String USD_SYMBOL = "$";
    public static final String ETH_SYMBOL = "HLC";
    public static final String POA_SYMBOL = "POA";
    public static final String ETC_SYMBOL = "ETC";
    public static final String HLC_SYMBOL = "HLC";
    ...
    public static final int HLC_DECIMALS = 11;
    public static final String HLC_DIVIDER = "100000000000";
