...
import static org.halykcoin.wallet.C.ETHEREUM_NETWORK_NAME;
import static org.halykcoin.wallet.C.HLC_SYMBOL;
import static org.halykcoin.wallet.C.KOVAN_NETWORK_NAME;
import static org.halykcoin.wallet.C.POA_NETWORK_NAME;
import static org.halykcoin.wallet.C.ROPSTEN_NETWORK_NAME;
import static org.halykcoin.wallet.C.CLASSIC_NETWORK_NAME;

public class EthereumNetworkRepository implements EthereumNetworkRepositoryType {

	private final NetworkInfo[] NETWORKS = new NetworkInfo[] {
			new NetworkInfo(ETHEREUM_NETWORK_NAME, HLC_SYMBOL,
                    "https://mainnet.infura.io/llyrtzQ3YhkdESt2Fzrk",
                    "https://api.trustwalletapp.com/",
                    "https://etherscan.io/",1, true),
            new NetworkInfo(CLASSIC_NETWORK_NAME, HLC_SYMBOL,
                    "https://mewapi.epool.io/",
                    "https://classic.trustwalletapp.com",
                    "https://gastracker.io",66, true),
            new NetworkInfo(POA_NETWORK_NAME, HLC_SYMBOL,
                    "https://core.poa.network",
                    "https://poa.trustwalletapp.com","poa", 99, false),
			new NetworkInfo(KOVAN_NETWORK_NAME, HLC_SYMBOL,
                    "https://kovan.infura.io/llyrtzQ3YhkdESt2Fzrk",
                    "https://kovan.trustwalletapp.com/",
                    "https://kovan.etherscan.io", 42, false),
			new NetworkInfo(ROPSTEN_NETWORK_NAME, HLC_SYMBOL,
