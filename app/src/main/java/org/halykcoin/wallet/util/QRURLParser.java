...
public class QRURLParser {
    ...
    public static final String QR_FIELD_ADDRESS = "ADDRESS";
    public static final String QR_FIELD_PAYMENT_ID = "PURCHASE_ID";
    public static final String QR_FIELD_AMOUNT = "AMOUNT";
    ...
    public Map<String, String> extractFieldsFromQrString(String url) {

        Map<String, String> qrCodeFields = new HashMap<>();
        String[] parts = url.split(":");
        if (parts.length <= 0) {
            return null;
        }
        ...
        for (String field : parts) {
            switch (field.length()) {
                case 95:
                    qrCodeFields.put(QR_FIELD_ADDRESS, field);
                    break;
                case 64:
                    qrCodeFields.put(QR_FIELD_PAYMENT_ID, field);
                    break;
                default:
                    qrCodeFields.put(QR_FIELD_AMOUNT, field);
                    break;
            }
        }
